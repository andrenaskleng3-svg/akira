import { baseUrl as _baseUrl } from "../../config/source.config.js";
import { default as Axios } from "axios";
import { load } from "cheerio";
import { requestFailed } from "../../core/error.handler.js";
...
export async function getAnimeProfile(req, res) {
...
export async function getDownloadBundle(req, res) {
  const id = req.params.id;
...
export async function epsAnime(req, res) {
  ...
  try {
    ...
    // obj.link_stream = await resolveMedia(streamLink);
